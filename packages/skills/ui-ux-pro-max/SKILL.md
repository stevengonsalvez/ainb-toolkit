...
user-invocable: true
external-source: https://github.com/nextlevelbuilder/ui-ux-pro-max-skill
version: "2.2.1"
---
...
| **Hover feedback** | Color/opacity transitions on hover | No indication element is interactive |
