...
Or use the `/compound` command to have Claude capture it automatically.
...
See `patterns/critical-patterns.md` for patterns that ALL agents should know about. These are automatically included in planning context.
